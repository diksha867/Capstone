...
const Dashboard = () => {
  ...
  const fetchQuote = useCallback(async () => {
    try {
      ...
      setQuote('You are doing your best today, and that is enough.');
    }
  }, []);
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-indigo-600 p-8 text-white shadow-xl md:p-10">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-bold">{greeting}, {user?.name} 👋</h1>
            <p className="mt-3 max-w-xl text-sm leading-relaxed text-purple-100">{quote}</p>
            <button
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData}>
                  <XAxis dataKey="mood" tick={{ fontSize: 12, fill: '#9CA3AF' }} />
