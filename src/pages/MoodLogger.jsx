...
const MoodLogger = () => {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      <h1 className="text-2xl font-bold dark:text-blue-500">Mood Logger</h1>
      <p className="text-sm text-gray-500 dark:text-dark:purple-300">
        Step {step} of 3
      </p>
      ...
      <div className="flex gap-3">
        {step > 1 && (
          <button
            ...
            className="rounded-md border px-4 py-2 dark:border-[#2D2450] dark:bg-[#2D2450] dark:text-purple-200"
          >
            Previous
          </button>
        )}
        {step < 3 ? (
          <button
            onClick={next}
            className="rounded-md bg-indigo-600 px-4 py-2 text-white dark:bg-purple-500"
          >
            Next
          </button>
        ) : (
          <button
            onClick={save}
            className="rounded-md bg-emerald-600 px-4 py-2 text-white dark:bg-purple-500"
          >
            Confirm & Save
          </button>
        )}
